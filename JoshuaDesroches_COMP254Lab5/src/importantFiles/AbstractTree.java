...
/**
 * An abstract base class providing some functionality of the importantFiles.Tree interface.
 *
...
public abstract class AbstractTree<E> implements Tree<E> {
  ...
  /**
   * Returns true if importantFiles.Position p has one or more children.
   *
  ...
  /**
   * Returns true if importantFiles.Position p does not have any children.
   *
   * @param p    A valid importantFiles.Position within the tree
  ...
  /**
   * Returns true if importantFiles.Position p represents the root of the tree.
   *
   * @param p    A valid importantFiles.Position within the tree
  ...
  /**
   * Returns the number of children of importantFiles.Position p.
   *
   * @param p    A valid importantFiles.Position within the tree
   * @return number of children of importantFiles.Position p
   * @throws IllegalArgumentException if p is not a valid importantFiles.Position for this tree.
   */
  @Override
  ...
  /** Returns the number of levels separating importantFiles.Position p from the root.
   *
   * @param p A valid importantFiles.Position within the tree
   * @throws IllegalArgumentException if p is not a valid importantFiles.Position for this tree.
   */
  ...
  /**
   * Returns the height of the subtree rooted at importantFiles.Position p.
   *
   * @param p A valid importantFiles.Position within the tree
   * @throws IllegalArgumentException if p is not a valid importantFiles.Position for this tree.
   */
  ...
  /**
   * Adds positions of the subtree rooted at importantFiles.Position p to the given
   * snapshot using a preorder traversal
   * @param p       importantFiles.Position serving as the root of a subtree
